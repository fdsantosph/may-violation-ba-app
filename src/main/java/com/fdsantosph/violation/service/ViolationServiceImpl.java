...
public class ViolationServiceImpl implements ViolationService {
	...
	@Override
	public List<Violation> findByPlateNo(String plateNoToSearch) {
		//return repository.findByPlateNo(plateNoToSearch);
		if (plateNoToSearch != null) {
			return repository.findAll(plateNoToSearch);
		}
		return repository.findAll();
	}
